...
contract InitializableTest is Test {
    ...
    function test_initializeRevertConstructor() public {
         // initializing new membership within constructor causes delegate call to fail
        bytes memory constructorInitializeData = abi.encodeWithSelector(
            ERC721Mage.initialize.selector, 
            owner, 
            name, 
            symbol,
